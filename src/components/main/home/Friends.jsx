...
const Friends = () => {
    return (
        <div className='my-4 space-y-2'>
            <p className='ml-2 text-2xl text-center font-bold'>Friends</p>
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2 px-10 place-items-center'>
